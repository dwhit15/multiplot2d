...
x_plotter.add_data(1,t_2col_matrix,y_2col_matrix,labels=["x1,y1","x2,y2"])
...
nine_nine_plotter.add_data("all",t_col_vector,y_9col_matrix,plots_share_data=True)
...
style_plotter.add_data(0,t_col_vector,y_2col_matrix,line_styles=shared_style)
individual_styles=[dict(ls=":",color="g"),dict(marker="o")]
style_plotter.add_data(1,t_col_vector,y_2col_matrix,line_styles=individual_styles)
style_plotter.set_plot_titles("all",["Shared Formatting","Individual Formatting"])

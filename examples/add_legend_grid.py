...
basic_plotter = MultiPlotter(1, size_inches=[6, 3],
                             name="legend and grid with no options")
basic_plotter.add_data(0, t_col_vector, y_2col_matrix,
...
options_plotter = MultiPlotter(1, size_inches=[6, 3],
                               name="legend and grid with some options")
options_plotter.add_data(0, t_col_vector, y_2col_matrix,
                         labels=["data 1", "data 2"])

...
compare_col.add_data("all", t_col_vector, y_3col_noise_matrix,
                     line_styles=measure_style, labels="Data")
...
compare_row = MultiPlotter([1, 3], size_inches=(7, 5/3.),
                           name="Model vs. Data")
compare_row.add_data("all", t_col_vector, y_3col_noise_matrix,
                     line_styles=measure_style, labels="Data")
